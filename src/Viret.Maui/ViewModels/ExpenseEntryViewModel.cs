...
public partial class ExpenseEntryViewModel : BaseViewModel
{
    ...
    public ExpenseEntryViewModel(IFinancialPlanningService financialPlanningService)
    {
    ...
    private async Task SaveExpenseAsync()
    {
        ...
        try
        {
            await _financialPlanningService.AddExpenseAsync(new Expense
            {
                FamilyId = familyId,
                UserId = userId,
